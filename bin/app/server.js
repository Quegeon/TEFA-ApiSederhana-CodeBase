...
function AppServer() {
  ...
  //cart
  this.server.get('/cart', jwtAuth.verifyToken, cartHandler.getAllCart);
  this.server.post('/cart/find/:id', jwtAuth.verifyToken, cartHandler.getCartById);
  this.server.post('/cart', jwtAuth.verifyToken, cartHandler.createCart);
  this.server.put('/cart/:id', jwtAuth.verifyToken, cartHandler.updateCart);
  this.server.del('/cart/:id', jwtAuth.verifyToken, cartHandler.deleteCart);
